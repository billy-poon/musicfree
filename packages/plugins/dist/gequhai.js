...
var http = createHttp("https://www.gequhai.com").raw;
var platform = "歌曲海";
var plugin = {
  platform,
  author: "Billy Poon",
  version: "0.0.1",
  srcUrl: "https://raw.githubusercontent.com/billy-poon/musicfree/refs/heads/master/packages/plugins/dist/gequhai.js",
  getTopLists() {
    return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      var html, $, result, parseRank, rankTitle, rankElement, data, hotSearch, _data;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            parseRank = function _parseRank($el) {
              return {
                id: $el.attr("href"),
                title: $el.text().trim()
                // description: '',
          ...
          case 1:
            ...
            result = [];
            rankTitle = "排行";
            rankElement = $("#navbarSupportedContent .navbar-nav .dropdown-toggle").toArray().find(function (x) {
              return $(x).text().trim() === rankTitle;
            });
            if (rankElement != null) {
              data = $(rankElement.parent).find("a.dropdown-item[href]").toArray().map(function (x) {
                return parseRank($(x));
              }).filter(function (x) {
                return x.id !== "/singer";
              });
            ...
            hotSearch = $(".ilingku_singerlist").first();
            if (hotSearch.length > 0) {
              _data = $(hotSearch).find("a[href]").toArray().map(function (x) {
                return parseRank($(x));
              });
              if (_data.length > 0) {
                result.push({
      ...
      return _regenerator().w(function (_context6) {
        while (1) switch (_context6.n) {
          case 0:
            ...
            _context6.n = 1;
            return requestSheet("/s/" + encodeURIComponent(query), page);
          case 1:
            result = _context6.v;
            if (!(result != null)) {
              _context6.n = 2;
...
function _requestSheet() {
  _requestSheet = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee8(url, page) {
    var _$$;
    var html, $, table, _parseTable, _parseTable2, head, first, rest, indexMap, data, title, $title, $lastPage, isEnd;
    return _regenerator().w(function (_context8) {
      while (1) switch (_context8.n) {
        ...
        case 1:
          html = _context8.v;
          $ = loadHTML(html);
          table = (_$$ = $("#myTable")[0]) !== null && _$$ !== void 0 ? _$$ : $("#myTables")[0];
          if (!(table == null)) {
            _context8.n = 2;
            break;
          }
        ...
        case 3:
          indexMap = {
            index: head.findIndex(function (x) {
              return x.text === "序号";
            }),
            artwork: first.findIndex(function (x) {
              return x.type === "image";
            }),
            title: head.findIndex(function (x) {
              return ["歌曲", "歌名"].includes(x.text);
            }),
            artist: head.findIndex(function (x) {
              return x.text === "歌手";
            })
          };
          data = [first, ...rest].map(function (x) {
            var _x$indexMap$artwork, _x$indexMap$artist$te;
            ...
            var artwork = ((_x$indexMap$artwork = x[indexMap.artwork]) === null || _x$indexMap$artwork === void 0 ? void 0 : _x$indexMap$artwork.type) === "image" ? x[indexMap.artwork].url : void 0;
...
function _requestMusic() {
  _requestMusic = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(url) {
    var _exec, _exec2, _res$data$url, _res$data, _exec3, _exec4, _exec5;
    var cache, html, _ref2, _ref3, mp3_id, _ref4, _ref5, _ref5$, mp3_type, type, res, mp3_url, result, $, _ref6, _ref7, title, _ref8, _ref9, artist, _ref0, _ref1, artwork, rawLrc;
    return _regenerator().w(function (_context9) {
      while (1) switch (_context9.n) {
        ...
        case 2:
          html = _context9.v;
          _ref2 = (_exec = /window\.play_id\s*=\s*'(.+)'/.exec(html)) !== null && _exec !== void 0 ? _exec : [], _ref3 = _slicedToArray(_ref2, 2), mp3_id = _ref3[1];
          _ref4 = (_exec2 = /window\.mp3_type\s*=\s*(\d+)/.exec(html)) !== null && _exec2 !== void 0 ? _exec2 : [], _ref5 = _slicedToArray(_ref4, 2), _ref5$ = _ref5[1], mp3_type = _ref5$ === void 0 ? "0" : _ref5$;
          if (!(mp3_id == null)) {
            _context9.n = 3;
            break;
          }
        ...
        case 6:
          ...
          $ = loadHTML(html);
          _ref6 = (_exec3 = /window\.mp3_title\s*=\s*'(.+)'/.exec(html)) !== null && _exec3 !== void 0 ? _exec3 : [], _ref7 = _slicedToArray(_ref6, 2), title = _ref7[1];
          _ref8 = (_exec4 = /window\.mp3_author\s*=\s*'(.+)'/.exec(html)) !== null && _exec4 !== void 0 ? _exec4 : [], _ref9 = _slicedToArray(_ref8, 2), artist = _ref9[1];
          _ref0 = (_exec5 = /window\.mp3_cover\s*=\s*'(.+)'/.exec(html)) !== null && _exec5 !== void 0 ? _exec5 : [], _ref1 = _slicedToArray(_ref0, 2), artwork = _ref1[1];
          rawLrc = $("#content-lrc2").text().trim();
